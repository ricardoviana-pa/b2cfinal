...
|---|---|---|---|
| 1 | 1 hora depois | Todos | A casa: tudo guardado, um clique para continuar, convite a responder (a equipa lê todas as respostas; o email sai de booking@ e nunca promete leitura pessoal). Se parou no **pagamento**: "Ficou algo por resolver?", com os métodos alternativos (Apple/Google Pay, PayPal, Klarna). |
