...
const STATIC_META: Record<string, { title: string; description: string; url: string }> = {
  ...
  '/adventures':  { title: 'Adventure Activities in Portugal | Horseback Riding, Canyoning & Surfing | Portugal Active', description: 'Guided adventure activities across Portugal — horseback riding, canyoning, surfing, hiking, wine tours & more. Book direct in Minho, Porto or Algarve.', url: `${BOT_BASE_URL}/adventures` },
  ...
  '/contact':     { title: 'Contact Portugal Active | Plan Your Stay in Portugal', description: 'Plan your Portugal stay with our concierge team. Luxury villa rentals, private chef, outdoor adventures. Phone, WhatsApp or email — we reply within 2 hours.', url: `${BOT_BASE_URL}/contact` },
