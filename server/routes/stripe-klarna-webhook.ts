...
import { constructStripeKlarnaWebhookEvent } from "../services/stripe-klarna";
    ...
    async (req: Request, res: Response) => {
      ...
      setImmediate(async () => {
        try {
          ...
          console.info(`[StripeKlarnaWebhook] Reservation created: ${reservation.reservationId} (${reservation.confirmationCode}) for PI ${pi.id}`);
        } catch (err: any) {
