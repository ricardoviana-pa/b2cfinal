...
export const CONFIRMATION_I18N: Record<EmailLang, ConfirmationStrings> = {
  pt: {
    ...
    bodyNamed: (n) => `Olá ${n}, boas-vindas à Portugal Active. A nossa equipa já está a preparar a casa para a sua chegada e o seu concierge acompanha tudo a partir de agora. Guarde o código abaixo, é a sua referência para qualquer pedido.`,
    ...
    included: "Incluído",
    confirm24h: "confirmação em 24 horas",
  ...
  en: {
    ...
    bodyNamed: (n) => `Hello ${n}, welcome to Portugal Active. Our team is already preparing the house for your arrival and your concierge is with you from here on. Keep the code below, it is your reference for any request.`,
  ...
  fr: {
    ...
    bodyNamed: (n) => `Bonjour ${n}, bienvenue chez Portugal Active. Notre équipe prépare déjà la maison pour votre arrivée et votre concierge vous accompagne à partir de maintenant. Conservez le code ci-dessous, c'est votre référence pour toute demande.`,
    ...
    included: "Inclus",
    confirm24h: "confirmation sous 24 heures",
  ...
  es: {
    ...
    bodyNamed: (n) => `Hola ${n}, bienvenido a Portugal Active. Nuestro equipo ya está preparando la casa para su llegada y su concierge le acompaña a partir de ahora. Guarde el código de abajo, es su referencia para cualquier petición.`,
    ...
    included: "Incluido",
    confirm24h: "confirmación en 24 horas",
  ...
  it: {
    ...
    bodyNamed: (n) => `Buongiorno ${n}, benvenuto in Portugal Active. Il nostro team sta già preparando la casa per il suo arrivo e il suo concierge la accompagna da questo momento. Conservi il codice qui sotto, è il suo riferimento per qualsiasi richiesta.`,
    ...
    included: "Incluso",
    confirm24h: "conferma entro 24 ore",
  ...
  de: {
    ...
    bodyNamed: (n) => `Hallo ${n}, willkommen bei Portugal Active. Unser Team bereitet das Haus bereits für Ihre Ankunft vor und Ihr Concierge begleitet Sie ab jetzt. Bewahren Sie den Code unten auf, er ist Ihre Referenz für jedes Anliegen.`,
    ...
    included: "Inklusive",
    confirm24h: "Bestätigung innerhalb von 24 Stunden",
  ...
  nl: {
    ...
    bodyNamed: (n) => `Hallo ${n}, welkom bij Portugal Active. Ons team bereidt het huis al voor op uw aankomst en uw concierge begeleidt u vanaf nu. Bewaar de code hieronder, het is uw referentie voor elk verzoek.`,
    ...
    included: "Inbegrepen",
    confirm24h: "bevestiging binnen 24 uur",
  ...
  sv: {
    ...
    bodyNamed: (n) => `Hej ${n}, välkommen till Portugal Active. Vårt team förbereder redan huset inför din ankomst och din concierge följer dig från och med nu. Spara koden nedan, den är din referens för alla önskemål.`,
    ...
    included: "Ingår",
    confirm24h: "bekräftas inom 24 timmar",
    ...
    bodyNamed: (n) => `Hei ${n}, tervetuloa Portugal Activeen. Tiimimme valmistelee jo taloa saapumistasi varten ja conciergesi on tukenasi tästä eteenpäin. Säilytä alla oleva koodi, se on viitteesi kaikkiin pyyntöihin.`,
    ...
    included: "Sisältyy",
    confirm24h: "vahvistus 24 tunnin kuluessa",
