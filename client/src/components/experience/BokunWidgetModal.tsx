/* ==========================================================================
   BOKUN WIDGET MODAL
   Luxury-styled modal that lazy-loads the official Bókun calendar widget.
   Keeps our sticky card design intact; Bókun handles the checkout flow
   via its own modal overlay (no separate shopping cart page).
   ========================================================================== */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Widget area — uses BokunWidgetsLoader for inline checkout */}
        <div className="bg-white overflow-y-auto" style={{ height: 'calc(100vh - 220px)', maxHeight: '780px', minHeight: '520px' }}>
          {BOKUN_CHANNEL_UUID ? (
            <BokunCalendarWidget
        ...
        <div className="px-6 py-3 flex items-center justify-between gap-3 border-t border-[#E8E4DC]">
          ...
          {BOKUN_CHANNEL_UUID && (
            <a
              href={`https://widgets.bokun.io/online-sales/${BOKUN_CHANNEL_UUID}/experience/${bokunActivityId}`}
              target="_blank"
