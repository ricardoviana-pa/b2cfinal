...
export default function Home() {
  ...
  const cities = useMemo(() => {
    return [...new Set(properties.filter(p => p.locality).map(p => p.locality))].sort();
  }, [properties]);
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7]">
      ...
      <section ref={s8Ref} className="fade-in section-padding bg-[#F5F1EB]">
        <div className="container">
          <p className="text-[12px] font-medium text-[#8B7355] mb-3" style={{ letterSpacing: '0.08em' }}>EXPERIENCES</p>
          <h2 className="headline-lg text-[#1A1A18] mb-10">Adventure, culture, and flavour.</h2>
          ...
          <div className="flex gap-5 overflow-x-auto no-scrollbar pb-2 -mx-5 px-5 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:overflow-visible">
            {[
              {
                title: 'Surf Lessons',
                body: "Catch your first wave on Portugal's legendary Atlantic coast.",
                img: 'https://images.unsplash.com/photo-1502680390548-bdbac40c7258?w=800&q=80',
                href: '/experiences/surf-lessons',
              },
              {
                title: 'Douro Valley Wine Tasting',
                body: 'Award-winning Port wines at historic quintas in the UNESCO-listed valley.',
                img: 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=800&q=80',
                href: '/experiences/wine-tasting-douro',
              },
              {
                title: 'Canyoning Adventure',
                body: 'Rappel waterfalls and jump into crystal pools in Gerês National Park.',
                img: 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800&q=80',
                href: '/experiences/canyoning',
              },
              {
                title: 'Porto Food Walk',
                body: "Discover Porto's culinary soul through markets, tascas, and Port cellars.",
                img: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&q=80',
                href: '/experiences/porto-food-tour',
              },
            ].map((exp, i) => (
          ...
          <div className="text-center mt-10">
            <Link
              href="/experiences"
              className="inline-flex items-center gap-2 text-[12px] tracking-[0.08em] font-medium text-[#1A1A18] border border-[#1A1A18] px-8 py-3.5 hover:bg-[#1A1A18] hover:text-white transition-colors"
            >
      ...
      {/* SECTION 8B: FOR OUR GUESTS (CONCIERGE) */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="relative overflow-hidden bg-[#E8E4DC]" style={{ aspectRatio: '4/3' }}>
              <img
                ...
                alt="Private chef cooking in a Portugal Active villa"
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </div>
            <div>
              <p className="text-[12px] font-medium text-[#8B7355] mb-3" style={{ letterSpacing: '0.08em' }}>CONCIERGE</p>
              <h2 className="headline-lg text-[#1A1A18] mb-5">Everything arranged. Nothing to manage.</h2>
              <p
                className="text-[16px] text-[#6B6860] mb-8 leading-relaxed"
                style={{ fontFamily: 'var(--font-body)', fontWeight: 300 }}
              >
                Every stay includes access to our concierge team. Private chef, in-villa spa, airport transfers, babysitting, housekeeping. One message and it is done.
              </p>
              <Link
                href="/concierge"
