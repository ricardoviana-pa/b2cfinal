...
export default function PayPalReturnPage() {
  ...
  useEffect(() => {
    ...
    /** H9: sem sessionStorage (PayPal abriu na app/nova tab) mas com o intent
      ...
      const iv = window.setInterval(async () => {
        ...
        try {
          ...
          if (it?.status === "paid" && it.reservationId) {
            ...
            navigate(`/booking/thank-you/${it.reservationId}?method=paypal`);
            return;
          }
    ...
    getPlatformStripe(stripeConfig.publishableKey).then(async (stripe) => {
      ...
      // "processing" não é terminal: o PayPal liquida em segundos — sondar em
